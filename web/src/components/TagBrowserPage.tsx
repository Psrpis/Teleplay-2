...
import { useAutoTagLibrary, useMediaSearch, useMediaTags, useMergeDuplicateFiles, useResetAndRetagSeries, MediaTag } from '../lib/api';
...
export default function TagBrowserPage({ kind }: { kind: 'series' | 'actor' }) {
    ...
    const resetAndRetag = useResetAndRetagSeries();
