...
function DashboardSkeleton() { return <div className="animate-pulse p-6 sm:p-12"><div className="h-[420px] rounded-3xl bg-dark-800/60" /><div className="mt-10 h-8 w-48 rounded bg-dark-800" /><div className="mt-5 flex gap-4">{[1, 2, 3, 4, 5].map((item) => <div key={item} className="h-32 w-60 rounded-2xl bg-dark-800/60" />)}</div></div>; }
